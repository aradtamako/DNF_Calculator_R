...
class ResultGUI:
    ...
    def create_background(self):
        ...
        self.result_canvas.create_text(248, 257, text="ステ+", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(248, 277, text="攻撃+", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(248, 297, text="属性", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(248, 317, text="持続", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(328, 317, text="%", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(245, 337, text="スキ攻", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(328, 337, text="%", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(248, 357, text="攻速", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(328, 357, text="%", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(245, 377, text="クリ率", fill='white', font=self.fonts[0], anchor='w')
        self.result_canvas.create_text(328, 377, text="%", fill='white', font=self.fonts[0], anchor='w')
